...
public partial class CmdPanel : Panel
{
	...
	[Signal]
	public delegate void ShipCommandEventHandler(CmdPanelOption option, Planet planet);
	...
	void _on_MoveButton_button_up(){
		EmitSignal("ShipCommand", (int)CmdPanelOption.MoveTo, _currentPlanet);
	}

	void _on_Conquer_button_up(){
		EmitSignal("ShipCommand", (int)CmdPanelOption.Conquer, _currentPlanet);
	}
